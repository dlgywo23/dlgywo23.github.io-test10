document.addEventListener('DOMContentLoaded', () => {
    ...
    const state = {
        ...
        currentSub: 'lesson',
        currentCareerTech: '제조기술', // Default career tab selection
    ...
    function init() {
        setupNavigation();
        setupTechTabs();
        setupCareerTabs(); // Initialize Career Validation
        setupGame();
    ...
    function setupCareerTabs() {
        const btns = document.querySelectorAll('.career-nav .tech-btn');
        btns.forEach(btn => {
            btn.addEventListener('click', () => {
                btns.forEach(b => b.classList.remove('active'));
                btn.classList.add('active');
                state.currentCareerTech = btn.dataset.careerTech;
                renderCareerData();
            });
        });
    }
    ...
    /* --- Data Loading --- */
    // JSON data embedded directly to support local file:// execution without CORS errors
    const hardcodedData = [
        {
            "기술분야": "제조기술",
            "기업명": "삼성전자",
            "주요 사업 및 수행 업무": "반도체(메모리/파운드리), 스마트폰, 가전제품 제조 및 소프트웨어 개발"
        },
        {
            "기술분야": "제조기술",
            "기업명": "SK하이닉스",
            "주요 사업 및 수행 업무": "DRAM 및 NAND 플래시 등 첨단 메모리 반도체 설계 및 제조"
        },
        {
            "기술분야": "제조기술",
            "기업명": "LG전자",
            "주요 사업 및 수행 업무": "가전(H&A), TV(HE), 전장 부품(VS) 제조 및 스마트 솔루션 제공"
        },
        {
            "기술분야": "제조기술",
            "기업명": "현대모비스",
            "주요 사업 및 수행 업무": "자동차 핵심 부품(모듈, 샤시, 전동화 시스템) 제조 및 AS 부품 공급"
        },
        {
            "기술분야": "제조기술",
            "기업명": "포스코홀딩스",
            "주요 사업 및 수행 업무": "철강(냉연/열연) 제조 및 이차전지 소재(리튬/니켈) 사업 관리"
        },
        {
            "기술분야": "제조기술",
            "기업명": "한화에어로스페이스",
            "주요 사업 및 수행 업무": "항공기 엔진, 자주포(K9), 장갑차 제조 및 우주 발사체 개발"
        },
        {
            "기술분야": "제조기술",
            "기업명": "두산에너빌리티",
            "주요 사업 및 수행 업무": "원자력/화력 발전 설비, 가스터빈, 해상풍력 등 에너지 기자재 제조"
        },
        {
            "기술분야": "제조기술",
            "기업명": "LS ELECTRIC",
            "주요 사업 및 수행 업무": "전력기기(차단기/변압기), 자동화 솔루션 및 스마트 그리드 구축"
        },
        {
            "기술분야": "제조기술",
            "기업명": "효성중공업",
            "주요 사업 및 수행 업무": "초고압 변압기, 차단기 등 전력 설비 제조 및 수소 충전소 건설"
        },
        {
            "기술분야": "제조기술",
            "기업명": "LG디스플레이",
            "주요 사업 및 수행 업무": "OLED 및 LCD 등 디스플레이 패널 제조와 차세대 디바이스 개발"
        },
        {
            "기술분야": "건설기술",
            "기업명": "삼성물산(건설)",
            "주요 사업 및 수행 업무": "초고층 빌딩(부르즈 할리파 등), 주택(래미안), 대형 플랜트 시공"
        },
        {
            "기술분야": "건설기술",
            "기업명": "현대건설",
            "주요 사업 및 수행 업무": "도로, 교량, 항만 등 토목 공사 및 원자력 발전소 시공 기술 보유"
        },
        {
            "기술분야": "건설기술",
            "기업명": "대우건설",
            "주요 사업 및 수행 업무": "LNG 플랜트 시공, 아파트(푸르지오) 건설 및 해외 인프라 사업"
        },
        {
            "기술분야": "건설기술",
            "기업명": "GS건설",
            "주요 사업 및 수행 업무": "정유/석유화학 플랜트 건설, 주택 사업(자이) 및 모듈러 주택 개발"
        },
        {
            "기술분야": "건설기술",
            "기업명": "DL이앤씨",
            "주요 사업 및 수행 업무": "교량 특수 시공(현수교 등), 석유화학 플랜트 및 주택(e편한세상) 사업"
        },
        {
            "기술분야": "건설기술",
            "기업명": "포스코이앤씨",
            "주요 사업 및 수행 업무": "제철 플랜트 시공, 친환경 건축 기술 및 리모델링 사업 특화"
        },
        {
            "기술분야": "건설기술",
            "기업명": "현대엔지니어링",
            "주요 사업 및 수행 업무": "화공/전력 플랜트 설계 및 시공, 자원 순환형 수소 생산 사업"
        },
        {
            "기술분야": "건설기술",
            "기업명": "롯데건설",
            "주요 사업 및 수행 업무": "초고층 랜드마크(롯데월드타워) 건축, 복합 단지 개발 및 주택 시공"
        },
        {
            "기술분야": "건설기술",
            "기업명": "SK에코플랜트",
            "주요 사업 및 수행 업무": "친환경 에너지 사업(수소/연료전지), 폐기물 처리 및 플랜트 시공"
        },
        {
            "기술분야": "건설기술",
            "기업명": "HDC현대산업개발",
            "주요 사업 및 수행 업무": "대규모 도시 개발 프로젝트(아이파크), 도로 및 철도 인프라 건설"
        },
        {
            "기술분야": "수송기술",
            "기업명": "현대자동차",
            "주요 사업 및 수행 업무": "승용/상용 자동차 제조, 전기차(IONIQ) 및 수소전기차 개발"
        },
        {
            "기술분야": "수송기술",
            "기업명": "기아",
            "주요 사업 및 수행 업무": "완성차 제조, 목적 기반 모빌리티(PBV) 개발 및 전동화 전환"
        },
        {
            "기술분야": "수송기술",
            "기업명": "HD현대중공업",
            "주요 사업 및 수행 업무": "초대형 컨테이너선, LNG운반선, 군함 제조 및 엔진 기술 개발"
        },
        {
            "기술분야": "수송기술",
            "기업명": "삼성중공업",
            "주요 사업 및 수행 업무": "고부가가치 선박 제조 및 부유식 액화천연가스 생산설비(FLNG) 건조"
        },
        {
            "기술분야": "수송기술",
            "기업명": "한화오션",
            "주요 사업 및 수행 업무": "함정, 잠수함 등 특수선 건조 및 해양 에너지 생산 설비 제조"
        },
        {
            "기술분야": "수송기술",
            "기업명": "대한항공",
            "주요 사업 및 수행 업무": "항공 운송(여객/화물), 항공기 유지보수(MRO) 및 무인기 개발"
        },
        {
            "기술분야": "수송기술",
            "기업명": "현대글로비스",
            "주요 사업 및 수행 업무": "완성차 물류, 해운 운송 및 공급망 관리(SCM) 시스템 운영"
        },
        {
            "기술분야": "수송기술",
            "기업명": "HMM",
            "주요 사업 및 수행 업무": "컨테이너선 중심의 해상 운송 서비스 및 글로벌 물류 네트워크 운영"
        },
        {
            "기술분야": "수송기술",
            "기업명": "제주항공",
            "주요 사업 및 수행 업무": "저비용항공사(LCC) 운송 서비스 제공 및 기재 현대화 기술 적용"
        },
        {
            "기술분야": "수송기술",
            "기업명": "현대철도",
            "주요 사업 및 수행 업무": "고속열차(KTX/SRT), 전동차 및 자기부상열차 제조 (현대로템 주력사업)"
        },
        {
            "기술분야": "통신기술",
            "기업명": "SK텔레콤",
            "주요 사업 및 수행 업무": "5G/6G 이동통신, AI 비서(A.), 메타버스 플랫폼 서비스"
        },
        {
            "기술분야": "통신기술",
            "기업명": "KT",
            "주요 사업 및 수행 업무": "유무선 통신 인프라, 지능형 네트워크 및 클라우드(DX) 솔루션"
        },
        {
            "기술분야": "통신기술",
            "기업명": "LG유플러스",
            "주요 사업 및 수행 업무": "이동통신 서비스, 스마트 홈(IoT), 기업 전용 회선 및 데이터센터"
        },
        {
            "기술분야": "통신기술",
            "기업명": "네이버(NAVER)",
            "주요 사업 및 수행 업무": "검색 엔진 플랫폼, 초거대 AI(HyperCLOVA X), 클라우드 컴퓨팅"
        },
        {
            "기술분야": "통신기술",
            "기업명": "카카오",
            "주요 사업 및 수행 업무": "모바일 메신저 플랫폼, AI 기반 서비스 연계 및 핀테크/모빌리티"
        },
        {
            "기술분야": "통신기술",
            "기업명": "삼성SDS",
            "주요 사업 및 수행 업무": "기업용 IT 서비스, 클라우드 시스템 통합(SI) 및 디지털 물류 솔루션"
        },
        {
            "기술분야": "통신기술",
            "기업명": "현대오토에버",
            "주요 사업 및 수행 업무": "차량용 소프트웨어 플랫폼, 내비게이션 및 스마트 팩토리 IT 서비스"
        },
        {
            "기술분야": "통신기술",
            "기업명": "안랩",
            "주요 사업 및 수행 업무": "통합 보안 솔루션 제공, 네트워크 보안 및 악성코드 대응 시스템"
        },
        {
            "기술분야": "통신기술",
            "기업명": "SK스퀘어",
            "주요 사업 및 수행 업무": "ICT 전문 투자 및 반도체/플랫폼 기업 포트폴리오 관리"
        },
        {
            "기술분야": "통신기술",
            "기업명": "LG CNS",
            "주요 사업 및 수행 업무": "데이터 분석, 생성형 AI 기반 업무 자동화 및 디지털 전환 서비스"
        },
        {
            "기술분야": "생명기술",
            "기업명": "삼성바이오로직스",
            "주요 사업 및 수행 업무": "바이오 의약품 위탁생산(CMO) 및 위탁개발(CDO) 서비스"
        },
        {
            "기술분야": "생명기술",
            "기업명": "셀트리온",
            "주요 사업 및 수행 업무": "바이오시밀러(복제약) 개발, 바이오 신약 연구 및 의약품 생산"
        },
        {
            "기술분야": "생명기술",
            "기업명": "유한양행",
            "주요 사업 및 수행 업무": "신약 개발(레이저티닙 등), 전문의약품 및 생활건강 제품 생산"
        },
        {
            "기술분야": "생명기술",
            "기업명": "한미약품",
            "주요 사업 및 수행 업무": "고혈압/당뇨 치료제 개발, 플랫폼 기술(LAPSCOVERY) 기반 신약 연구"
        },
        {
            "기술분야": "생명기술",
            "기업명": "GC녹십자",
            "주요 사업 및 수행 업무": "혈액제제, 백신 개발 및 희귀 질환 치료제 연구 생산"
        },
        {
            "기술분야": "생명기술",
            "기업명": "종근당",
            "주요 사업 및 수행 업무": "혁신형 개량신약 개발, 항암제 및 만성질환 치료제 제조"
        },
        {
            "기술분야": "생명기술",
            "기업명": "대웅제약",
            "주요 사업 및 수행 업무": "보툴리눔 톡신(나보타), 위식도역류질환 신약 개발 및 생산"
        },
        {
            "기술분야": "생명기술",
            "기업명": "SK바이오팜",
            "주요 사업 및 수행 업무": "뇌전증 등 중추신경계 신약 개발 및 글로벌 직판망 운영"
        },
        {
            "기술분야": "생명기술",
            "기업명": "마크로젠",
            "주요 사업 및 수행 업무": "유전체 분석 서비스, 정밀 의학 솔루션 및 유전자 감식"
        },
        {
            "기술분야": "생명기술",
            "기업명": "바이오니아",
            "주요 사업 및 수행 업무": "분자진단 시약/장비 제조 및 RNAi 기반 치료제 연구 개발"
        }
    ];

    async function fetchData() {
        // Use hardcoded data directly
        state.techData = hardcodedData;
        state.loadingJSON = false;
        // If we are already on the career tab, render immediately
        if (state.currentNav === 'career') {
            renderCareerData();
        }
    }
    ...
    function renderCareerData() {
        ...
        const targetTech = state.currentCareerTech;

        // Filter Data based on selection
        const filtered = state.techData.filter(item => item['기술분야'] === targetTech);

        if (filtered.length === 0) {
            container.innerHTML = "<p style='grid-column: 1/-1; text-align: center; color: #888;'>데이터를 불러오는 중이거나 해당 분야의 기업이 없습니다.</p>";
            return;
        }
